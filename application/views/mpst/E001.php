...
<?php  foreach ($listMpst as $detail) { ?>
<input type="hidden"  name="base_url" ID="base_url" value="<?php echo $base_url; ?>">
<input type="hidden"  ID="idx" value="<?php echo $idx; ?>" >
<div class="form_input">
	<p>รหัสกลุ่มผู้ใช้งาน</p>
	<input type="text" class="input" name="mpst_code" value="<?php echo $detail->mpst_code;   ?>" readonly>
	<input type="hidden" class="input" name="id_mpst" value="<?php echo $detail->id_mpst;   ?>" >
	<p>ชื่อกลุ่มผู้ใช้งาน(ENG)</p>
	<input type="text" class="input" name="name_en" id="name_en" value="<?php echo $detail->name_en; ?>" >
	<p>ชื่อกลุ่มผู้ใช้งาน(TH)</p>

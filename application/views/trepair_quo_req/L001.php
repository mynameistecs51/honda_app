...
<div class="search form-inline">ค้นหา : 
    <input type="text" data-column="0"  class="search-input-text" placeholder="--เลขที่แจ้งเสนอราคา--"> 
    ...
    <select data-column="4" class="search-input-select search">
      ...
      <option style="font-size:12px;" value="1">แจ้งแล้ว</option> 
      <option style="font-size:12px;" value="2">เสนอราคาแล้ว</option> 
      <option style="font-size:12px;" value="3">ยืนยันซ่อม</option> 
      <option style="font-size:12px;" value="0">ยกเลิกซ่อม</option> 
    </select>
    <br/>
...
<thead>                       
  <tr>
    <th width="150">เลขที่ใบ<?php echo $pagename; ?></th> 
    <th width="140">วันที่<?php echo $pagename; ?></th>   
    <th width="150">เลขที่ใบเปิดงานซ่อม</th>
    <th width="200">บริษัทหลัก</th> 
    <th width="200">ไซต์งาน</th> 
    <th width="200">เลขที่ผลิตภัณฑ์ [S/N]</th> 
    <th width="150">ช่างผู้แจ้ง</th>

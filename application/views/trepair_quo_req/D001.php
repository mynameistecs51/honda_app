...
<input type="hidden"  name="base_url" ID="base_url" value="<?php echo $base_url; ?>">
    ...
    <div class="col-md-3" >
      ...
      <input type="text" class="form-control" name="telephone" value="IN-20150001" readonly>
    </div>
    <div class="col-md-3">
      <p>เลขที่<?=$pagename?></p>
      <input type="text" class="form-control" name="telephone"  value="QR1500001" readonly="true">
    </div>
    <div class="col-md-3">
      <p>วันที่<?=$pagename?></p>
...
<div class="col-md-4" style="text-align:left;">
            ...
            <table class="table table-striped" id="tb_check">
              <thead>
                <tr>
                  ...
                  <th width="15%">วันที่เริ่มประกัน</th>
                  <th width="15%">วันที่สิ้นสุดประกัน</th>
                  <th width="20%">หมายเหตุ</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td><input readonly type="text" class="form-control" name="namemodel[]" value="BOM1500001"></td>
  ...
  <div class="row form_input header_table" style="text-align:left; margin-top:10px;">
    <div class="col-md-12">
      <fieldset>
        <legend>รายการแจ้งเสนอราคา</legend>

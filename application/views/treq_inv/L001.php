...
<div class="search form-inline">ค้นหา : 
    <input type="text" data-column="0"  class="search-input-text" placeholder="--เลขที่ใบ<?php echo "$pagename"?>--"> 
    <input type="text" data-column="1"  class="search-input-text" placeholder="--เลขที่ใบงาน--">
    <input type="text" data-column="2"  class="search-input-text" placeholder="--ชื่อไซด์งาน--">
    <select data-column="3" class="search-input-text">
    <option style="font-size:12px;" value="0,1,2" selected>----ทั้งหมด----</option>
    <option style="font-size:12px;" value="1">รอเบิก</option> 
    <option style="font-size:12px;" value="2">รอจ่าย</option> 
    <option style="font-size:12px;" value="3">รอรับ</option>
    <option style="font-size:12px;" value="4">รับอะไหล่แล้ว</option> 
    <option style="font-size:12px;" value="5">ยกเลิก</option>  
    </select>
    <div>

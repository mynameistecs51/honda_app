...
function add_row() 
{
  ...
  var html  ='<tr id="'+rows+'">';
      ...
      html +='<td><input type="text" class="form-control" name="receive_deliver[]"></td>';
      ...
      html +='<input type="text" name="treq_repair_date" ID="treq_repair_date"  value="<?=$dtnow?>" readonly="readonly" class="form-control "> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>';
      html +='</div>';
      html +='</td>';
      html +='<td><select name="delivery_type" id="delivery_type" class="form-control">';
      html +='<option>--เลือก--</option>';
      html +='<option>รถบริษัท</option>';
      html +='<option>รถรับจ้าง</option>';
      html +='<option>ขนส่งตา่งจังหวัด</option>';
      html +='<option>ฝ่ายบริการดำเนินการ</option>';
      html +='<option>Sub ดำเนินการ</option>';
      html +='</select></td>';
      html +='<td>';
      html +='<select name="pack_type" id="pack_type" class="form-control">';
      html +='<option>--เลือก--</option>';
      html +='<option>มาตรฐาน</option>';
      html +='<option>ขนส่งต่างจังหวัด</option>';
      html +='<option>ตีลังไม้</option>';
      html +='<option>ไม่แพ็ค</option>';
      html +='</select>';
      html +='</td> ';
      html +='</tr>'; 

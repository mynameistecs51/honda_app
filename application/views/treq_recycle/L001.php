...
function check_authen()
{
 ...
 $('#employee-grid tbody td.action').html(html);
   var html2 ='';
      ...
      if($('#btn_print').val()==1){ 
          html2 +='<img src="<?php echo base_url(); ?>images/list_print.png"   title="พิมพ์" class="btnopt print" data-idprint="1"></img>';
      }else{ 
          html2 +='<img src="<?php echo base_url(); ?>images/un_list_print.png"   title="ไม่ได้รับสิทธิ์พิมพ์เอกสาร" class="btnoptUnclick" data-idedit="0"></img>';
      }
          html2 +='<input type="hidden" ID="id_memp" value="0">';
...
<div class="search form-inline">ค้นหา : 
    ...
    <input type="text" data-column="1"  class="search-input-text" placeholder="--เลขที่ใบรับคืนของเสีย--">  
    <input type="text" data-column="2"  class="search-input-text" placeholder="--รหัสผลิตภัณฑ์ [S/N]--">  
    <select data-column="3" class="search-input-select">
    <option style="font-size:12px;" value="0,1,2" selected>----สถานะ ทั้งหมด----</option>
    <option style="font-size:12px;" value="1">รอซ่อม</option> 
    <option style="font-size:12px;" value="2">กำลังดำเนินการ</option> 
    <option style="font-size:12px;" value="3">ซ่อมเสร็จแล้ว</option> 
    </select> 
    <br/>
    <lable class="lable">From :</lable><input type="text" data-column="5" ID="datefrom"  class="search-input-text" value="<?php echo $datefrom; ?>" > 
    <lable class="lable">To :</lable><input type="text" data-column="6"  ID="dateto" class="search-input-text" value="<?php echo $dateto; ?>" style="width:160px; margin-right:5px;"> 
</div>
<table id="employee-grid"  cellpadding="0" cellspacing="0" class="table table-striped table-hover" width="100%"  >
<thead>                       
  <tr>
    <th>เลขที่ใบรับคืนของเสีย</th>

...
<div class="search form-inline">ค้นหา : 
    ...
    <input type="text" data-column="2"  class="search-input-text" placeholder="--ชื่อไซด์ลูกค้า--">  
...
<thead>                       
  <tr>
    ...
    <th>ประเภทงาน</th>
    <th>ชื่อไซต์ลูกค้า</th> 
    <th>ชื่อบริษัทหลัก</th>
    <th>ผู้คืน</th> 
    <th>วันที่-เวลา<?php echo "$pagename";?></th>
    <th>สถานะ</th>
    <th>หมายเหตุ</th>
...
<tbody>
  <tr>
    ...
    <td>CM-20150001</td>
    <td>เคลม</td>
    <td>หจก.โฮมเซอร์วิส แอนด์ อิเลคทริคคอม</td>
    <td>หจก.โฮมเซอร์วิส แอนด์ อิเลคทริคคอม</td>
    <td>sirawit (ช่างซ่อม)</td> 
    <td><?=$dtnow?></td>
    <td>เปิดงาน</td>
    <td>-</td>
    <td class="action" ></td>

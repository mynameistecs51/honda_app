...
function run_auto()
  {
      ...
      $('#tstock_mitm_name').val('Bettery 12V');
...
<thead>
  ...
  <tr>
    ...
    <div class="form-group col-md-15">
     <select name="tstock_msku" id="tstock_msku" class="selectpicker show-tick form-control input-sm "  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก"  >

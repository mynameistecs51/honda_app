...
function add_tr()
{
	var trhtml ='<tr>';
		...
		trhtml +='<option style="font-size:12px;" value="1">91411</option>'; 
		trhtml +='<option style="font-size:12px;" value="2">30611</option>'; 
		trhtml +='<option style="font-size:12px;" value="3">32548</option>';
		trhtml +='</select>';
		trhtml +='<div class="help-block with-errors"></div>';
		trhtml +='</div>';
	 	trhtml +='</td>';
 	 	trhtml +='<td><input type="text" class="input form-control tclaim_amount" name="amount[]" value="" style="text-align:right;"></td>';
 	 	trhtml +='<td><input type="text" class="input form-control" name="namesn_old[]" required="true"></td>';
 	 	trhtml +='<td>';
		trhtml +='<div class="form-group">';
		trhtml +='<select name="tclaim_mcmp" class="selectpicker show-tick form-control input-sm tclaim_mcmp"  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก"  >';
		trhtml +='<option style="font-size:12px;" value="" selected>----เลือก----</option>';
		trhtml +='<option style="font-size:12px;" value="1">กล่อง</option>'; 
		trhtml +='<option style="font-size:12px;" value="2">ชิ้น</option>'; 
		trhtml +='<option style="font-size:12px;" value="3">ก้อน</option>';
		trhtml +='</select>';
		trhtml +='<div class="help-block with-errors"></div>';
		trhtml +='</div>';
	 	trhtml +='</td>';

	...
	<div class="row form_input">
      ...
      <p class="required">*</p> 
		...
		<div class="col-md-4" style="text-align:left;">
			...
			<div class="form-group">
			<input type="text" name=""  value="CS1506-0390" class="form-control" readonly="" >   
			</div>   
		</div>
		<div class="col-md-4" style="text-align:left;">
    <p>วันที่เบิกยืม</p>   
      <div class="input-group" style="z-index:8  !important;">
      <input type="text" name="treq_repair_date" id="treq_repair_date_" value="<?=$dtnow?>"   class="form-control " readonly="true"> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
      </div>
    </div>
    <div class="col-md-4" style="text-align:left;">
			<p>วันที่กำหนดยืม</p>
      <p class="required">*</p>      
			<div class="input-group" style="z-index:8  !important;">
			<input type="text" name="treq_repair_date" id="treq_repair_date" value="<?=$dateto?>"  class="form-control "> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
			</div>
		</div>
    <div class="col-md-4" style="text-align:left;">
      <p>วันที่กำหนดคืน</p>
...
<div class="col-md-6">
      ...
      <div class="row form_input" style="text-align:left; margin:0;">
        ...
        <div class="col-md-5">
          <div class="row form_input" style="text-align:left; margin:0;">
            ...
            <input type="text" class="input form-control" ID="call_main" name="telephone" value="0821428742">
          </div>
          <div class="row form_input" style="text-align:left; margin:0;">
            <p>Fax.</p>
            <input type="text" class="input form-control" ID="fax_main" name="telephone" value="027549336">
          </div>
        </div>
      </div>
      <div class="row form_input" style="text-align:left; margin:0;">
	...
	<div class="row form_input">
		<div class="col-md-6" style="text-align:left;">
			...
			<div class="form-group" >
			<input type="text" name="" value="Work Shop" class="form-control" readonly="true"> 
			</div>
		</div>
		<div class="col-md-6" style="text-align:left;">
			<p>ผู้<?php echo "$pagename"?></p>
			<div class="form-group">
			<input type="text" name="" value="สิรวิชญ์ นาทันดอน" class="form-control" readonly="true">   
			</div> 
		</div>
	</div>
...
<div class="col-md-12">
<fieldset>
<legend>รายการเบิกยืมผลิตภัณฑ์</legend>  
...
<tbody>
  <tr>
    ...
    <td><input type="text" name="" value="" class="form-control" readonly=""></td> 
    <td><input type="text" name="" value="" class="form-control" readonly=""></td>   
    <td><input type="text"  value="1" class="form-control" style="text-align:right;"></td>
    <td>
      <div class="form-group col-md-15">
       <select name="minv_dtl" class="selectpicker show-tick form-control input-sm tclaim_mcmp"  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก"   >
          <option style="font-size:12px;" value="" >----เลือก----</option>
          ...
          <option style="font-size:12px;" value="3"selected>ก้อน</option>  
       </select>
      <div class="help-block with-errors"></div>
      </div> 
    </td>
  ...
  <div class="col-md-12" style="text-align:left;">
  <p>สถานะ</p>  
    <input type="radio"  name="" value="1"   checked=checked;>  รอเบิก
    <input type="radio"  name="" value="2"  >   รับจ่าย
    <input type="radio"  name="" value="3"  >   รอรับ
    <input type="radio"  name="" value="4"  >   รับอะไหล่แล้ว

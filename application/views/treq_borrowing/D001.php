...
<div class="row form_input">
    ...
    <div class="col-md-4" style="text-align:left;">
	    <p>เลขที่ใบ<?php echo "$pagename"?></p>
	  	<div class="form-group">
	   	<input type="text" name=""  value="CS1506-0390" class="form-control" readonly="readonly" >   
	  	</div>   
		</div>
    <div class="col-md-4" style="text-align:left;">
    <p>วันที่เบิกยืม</p>     
      <div class="input-group" style="z-index:8  !important;">
      <input type="text" name="docdate-" id="docdate-" readonly="" value="<?=$dtnow?>"   class="form-control "> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
      </div>
    </div>
    <div class="col-md-4" style="text-align:left;">
		<p>วันที่กำหนดยืม</p>     
...
<div class="row form_input">
<div class="col-md-12">
<div class="row form_input header_table" style="margin-top:-5px;">
...
<tbody>
  <tr>
    <td><input type="text" name="" value="PPPPP"   class="form-control" readonly ></td>
    <td><input type="text" name="" value="main board"   class="form-control" readonly="true" ></td>
    <td><input type="text" name="" value=""   class="form-control" readonly ></td>
    <td><input type="text" name="" value=""   class="form-control" readonly ></td>
    <td><input type="text" name="" value=""   class="form-control" readonly ></td>  
    <td><input type="text" name="" value="25"   class="form-control" style="text-align:center;" readonly ></td>  
    <td>

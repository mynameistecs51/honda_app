  ...
  <div class="col-md-12">
    ...
    <div class="row form_input" style="text-align:left;margin-top:-10px;">
      ...
      <div class="col-md-3" style="text-align:left;">
        ...
        <p><a href="<?php echo base_url(); ?>file_upload/tpm_overall/ผลการทดสอบ-PM001.pdf" target="_blank">สรุปผล-PM001.pdf</a></p>
      </div>
    </div>
    <div class="row form_input" style="text-align:left;">
      <div class="col-md-8" style="text-align:left;">
        <p>เหตุผล/การดำเนินการ</p>
        <textarea class="form-control issue"  placeholder="--กรุณาระบุให้ครบถ้วน--"></textarea>
      </div>
    </div>
    </fieldset>
  </div>
  ...
  <div class="col-md-12" style="text-align:left;">
    <fieldset>
      ...
      <div class="row form_input"> 
        <div class="col-md-3" style="text-align:left;">
          <p>แนบไฟล์ปิดงาน</p>
          <p><a href="<?php echo base_url(); ?>file_upload/tpm_overall/closed-PM58WT00001-04.pdf" target="_blank">closed-PM58WT00001-04.pdf</a></p>
        </div>

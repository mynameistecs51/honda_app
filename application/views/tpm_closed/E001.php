...
<div class="col-md-3" style="text-align:left;">
  <p>เลขที่ใบเปิดงานบำรุงรักษาเชิงป้องกัน</p>
...
<div class="col-md-3" style="text-align:left;">
  <p>วันที่เปิดงานบำรุงรักษาเชิงป้องกัน</p><p class="required">*</p>
...
<div class="col-md-2" style="text-align:left;">
  ...
  <select name="tpm_dtl_sub_batch" ID="seltpmdtlsubbatch" class="selectpicker show-tick form-control input-sm tclaim_mcmp"  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก"  disabled="true">
    <option style="font-size:12px;" value="" >----เลือก----</option> 
    <option style="font-size:12px;" value="1" selected>Routine</option>
    ...
    <fieldset>
      ...
      <div class="row form_input"> 
        ...
        <div class="col-md-3" style="padding-top:20px;">
          <input type="checkbox" id="chk_com_sit" checked="true" > ยืนยันการปิดงาน
        </div>
      </div>
    </fieldset>
  </div>

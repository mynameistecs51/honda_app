...
<div class="search">ค้นหา : 
    <input type="text" data-column="0"  class="search-input-text" placeholder="--เลขที่ใบแจ้งเสนอราคา--"> 
    <input type="text" data-column="1"  class="search-input-text" placeholder="--เลขที่ใบเปิดงานซ่อม--"> 
    <input type="text" data-column="3"  class="search-input-text" placeholder="--เลขที่ใบเสนอนราคา CSMILE--"> 
    <input type="text" data-column="4"  class="search-input-text" placeholder="--บริษัทหลัก--"> 
    <input type="text" data-column="5"  class="search-input-text" placeholder="--บริษัทไซต์งาน--"> 
    <input type="text" data-column="6"  class="search-input-text" placeholder="--ชื่อช่างเทคนิค--"> 
    <br>
    <input type="text" data-column="7"  class="search-input-text" placeholder="--S/N--"> 
    <lable class="lable"> From :</lable><input type="text" data-column="8" ID="datefrom"  class="search-input-text" value="<?php echo $datefrom; ?>" > 
    <lable class="lable"> To :</lable><input type="text" data-column="9"  ID="dateto" class="search-input-text" value="<?php echo $dateto; ?>" style="width:160px; margin-rigth:5px;"> 
    <select data-column="10" class="search-input-select">
      <option style="font-size:12px;" value="0,1,2" selected>----สถานะ ทั้งหมด----</option>
      <option style="font-size:12px;" value="1">ยืนยันแล้ว</option> 
      <option style="font-size:12px;" value="2">รอยืนยัน</option> 
      <option style="font-size:12px;" value="2">ยกเลิกรายการ</option> 
    </select>
</div>
...
<thead>                       
  <tr>
    <th width=9%>วันที่-เวลา<br>ใบแจ้งเสนอราคา</th>
    <th width=9%>เลขที่<br>ใบแจ้งเสนอราคา</th> 
    <th width=10%>เลขที่ใบเปิดงานซ่อม</th> 
    <th width=10%>เลขที่ใบเสนอราคา CSMILE</th> 
    <th width=10%>เลขที่ใบสั่งซื้อ[PO] CSMILE</th> 
    <th width=15%>บริษัทหลัก</th>
    <th width=15%>บริษัทไซต์งาน</th>
...
<tbody>
  ...
  <tr>
    ...
    <td>นาย A</td>
    <td>รอยืนยัน</td>
    <td><img src="<?php echo base_url(); ?>images/list_add.png"   title="เปิดงานซ่อม" class="btnopt opencase"  data-idview="0"></img></td>
  </tr>
  <tr>
    <td><?php echo $datefrom; ?></td>
   <td>QR-20150001</td>

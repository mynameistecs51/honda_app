...
function cancle() {
	if(confirm("ยกเลิกการดำเนินการ หรือไม่ ?"))
	{
		...
		location = base+"/minv_unt";
	}
}

function updateMinv_unt()
  {
    $('#form').on('submit', function (e) {
        ...
        var comment= $('#comment').val(); 
            ...
            {
                type: 'POST',
                url: '<?php echo base_url(); ?>minv_unt/saveUpdate/',
...
<?php  foreach ($listMinv_unt as $detail) { ?>
...
<div class="form_input">
	...
	<input type="hidden" class="input" name="id_minv_unt" value="<?php echo $detail->id_minv_unt;   ?>" >

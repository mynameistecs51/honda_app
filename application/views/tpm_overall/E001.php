...
<div class="col-md-3" style="text-align:left;">
  ...
  <p class="required">*</p>
  <input type="text" name="msn_hdr_code" value="PM58WT00001"  class="form-control" readonly="true" >   
  </div>   
</div>
<div class="col-md-3" style="text-align:left;">
  <p>วันที่เปิดงานสัญญาบริการ </p><p class="required">*</p>
  <div class="input-group" style="z-index:9  !important;">
  <input type="text" name="dateTpm" ID="dateTpm-"  value="01/09/2558 08:00" readonly="readonly" class="form-control "> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
  </div>
</div>  
<div class="col-md-3" style="text-align:left;">
...
<div class="col-md-3" style="text-align:left;">
  <p>ผู้บันทึก<?php echo $pagename; ?></p> 
  <p class="required">*</p> 
...
<div class="row form_input" style="margin-top:10px;">
  <div class="col-md-12" style="text-align:left;">
    <p>สถานะ</p>  
      <input type="radio"  name="status" value="1"  disabled checked=checked> เปิดงาน
      <input type="radio"  name="status" value="2" disabled >  บันทึกผลการปฏิบัติงาน  
      <input type="radio"  name="status" value="3" disabled >  ปิดงาน 
...
function add_tr(numrow)
{
  ...
  var trhtml  ='<tr  class="num_dtl">';
      ...
      trhtml +='<option style="font-size:12px;" value="" selected>ช่างผู้ปฏิบัติงาน</option> ';
      trhtml +='</select>';
      trhtml +='</td>';
      trhtml +='<td>';

...
$(function(){
 ...
 $('#employee-grid tbody').on( 'click', 'img.edit', function () {
          ...
          edit($(this).data('idedit'),idx,$(this).data('idedit'));
        //  var idx = $(this).index();
...
function check_authen()
{
  var html =''; 
      if($('#btn_edit').val()==1){ 
          html +='<img src="<?php echo base_url(); ?>images/list_add.png"   title="แก้ไข" class="btnopt edit" data-idedit="1"></img>';
      }else{ 
          html +='<img src="<?php echo base_url(); ?>images/un_list_add.png"   title="ไม่ได้รับสิทธิ์แก้ไขข้อมูล" class="btnoptUnclick" data-idedit="1"></img>';
      }
...
var htmlv =''; 
      if($('#btn_view').val()==1){ 
          htmlv +='<img src="<?php echo base_url(); ?>images/list_view.png"   title="แก้ไข" class="btnopt view" data-view="0"></img>';
      }else{ 
          htmlv +='<img src="<?php echo base_url(); ?>images/un_list_view.png"   title="ไม่ได้รับสิทธิ์แก้ไขข้อมูล" class="btnoptUnclick" data-view="0"></img>';
      }
          htmlv +='<input type="hidden" ID="id_memp" value="0">';
 $('#employee-grid tbody td.action_view').html(htmlv);
}
...
function edit(num,idx,is_phase)
    {   
      var screenname="เพิ่มข้อมูล :: <?php echo $pagename; ?>"; 
      var baseurl_edit = $('#baseurl_edit').val();
      var url=baseurl_edit+num+"/"+idx+"/"+is_phase; 
      var n=0;
      $('.div_modal').html('');
      modal_form(n,screenname);
      $('#myModal'+n+'.modal-body').html('<img id="ajaxLoaderModal" src="<?php echo base_url(); ?>images/loader.gif"/>');
...
<thead>                       
  <tr>
    <th width="230">เลขที่ใบเปิดงานสัญญาบริการ</th>  
    ...
    <th width="150">สรุปผลการปฎิบัติงาน</th> 

...
function add_tr()
{
  var trhtml ='<tr>';
    ...
    trhtml +='<td><input type="text" class="input form-control" </td>';
    trhtml +='<td><input type="text" class="input form-control" </td>';
    trhtml +='<td><input type="text" class="input form-control" </td>';
...
<div class="row form_input">
  <div class="col-md-3" style="text-align:left;">
    ...
    <input type="text" name="" value="TF5807000" readonly="true" class="form-control" >   
    </div>   
  </div> 
  <div class="col-md-3" style="text-align:left;">
    <p>วันที่จ่ายยืม</p>
...
<div class="row form_input">
  <div class="col-md-3" style="text-align:left;">
    ...
    <div class="form-group">
    <input type="text" name="" value="T00001"  class="form-control"  readonly="true" >   
    </div> 
  </div>
  <div class="col-md-3" style="text-align:left;">
...
<div class="col-md-12">
  ...
  <div class="col-md-12" style="text-align:left;">
  <p>สถานะ</p>  
    <input type="radio"  name="" value="1"  disabled checked=checked;> รอรับ
    <input type="radio"  name="" value="2" disabled >  รับแล้ว  

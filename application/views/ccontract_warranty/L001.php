...
<div class="search form-inline">ค้นหา : 
    ...
    <input type="text" data-column="1"  class="search-input-text" placeholder="--บริษัทหลัก--">  
    <input type="text" data-column="1"  class="search-input-text" placeholder="--สถานที่ไซต์งาน--">  
...
<thead>                       
  <tr>
    <th width="180">เลขที่ <?php echo $pagename; ?></th>  
    <th width="180">ประเภท <?php echo $pagename; ?></th>
    ...
    <th width="150">วันที่นัดหมาย PM</th> 
...
<tbody>
  <tr>
    ...
    <td>PPPPP-SSYYLXXX-VVV<br>PPPPP-SSYYLXXX-VVV<br>PPPPP-SSYYLXXX-VVV</td>
    <td>1<br>2<br>3<br>4</td> 
    <td>01/01/2558<br>01/03/2558<br>01/06/2558<br>01/09/2558</td>  
    <td>ในสัญญา</td>
    <td>-</td>
    <td class="action"> </td>
  </tr>

...
<div class="col-md-6" style="text-align:left;">
  ...
  <p class="required">*</p>
  <input type="text" class="form-control" name="contract_code" style="background-color:#81BEF7;color:#FFFFFF;" value="-สร้างโดยระบบ-" readonly>   
  </div>   
</div> 
<div class="col-md-6" style="text-align:left;">
...
<input type="text" class="form-control" name="ref_contract_code"> 
</div>
<div class="col-md-6" style="text-align:left;">
...
<div class="row form_input spare-table" style="margin-top:-20px;">
  <div class="col-md-3">
    <div class="add addinv" style="margin-bottom:10px; margin-right:10px;">
    + เพิ่มรายการ
    </div>
    <div class="add delinv" style="margin-bottom:10px;">
    - ลบรายการ
    </div>
  </div> 
  </div>
  ...
  <table class="table table-striped" id="tbspare">
    <thead>
      <tr>
      <th width="30"><input type="checkbox" id="cball"></th>
    ...
    <tbody>
      ...
      <td> 
        <select name="selwrt" ID="selwrt" class="selectpicker show-tick form-control input-type"  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก"  >
          <option style="font-size:12px;" value="" selected>-- เลือก --</option>
          <option style="font-size:12px;" value="1">งานขายปกติ</option>  
          <option style="font-size:12px;" value="2">งานซ่อม</option> 
          <option style="font-size:12px;" value="2">งาน MA</option>
          <option style="font-size:12px;" value="2">งาน Out off Warranty</option>  
          <option style="font-size:12px;" value="2">งานต่อเนื่องในประกัน</option> 
        </select>  
      </td> 
      <td> 
          <input type="checkbox" id="chk_main_site"> เลือกที่เดียวกับบริษัทหลัก<p class="required">*</p>
          <textarea class="form-control" row="1" placeholder="-- เลือก --"></textarea>
      </td>
      </tr>
    </tbody>
  </table>   
...
{ 
  ...
  var html='<tr>';
      ...
      html +='</td>'; 
      html +='<td>';
      html +='<input type="checkbox" id="chk_main_site"> เลือกที่เดียวกับบริษัทหลัก<p class="required">*</p>';
      html +='<textarea class="form-control" row="1" placeholder="-- เลือก --"></textarea></td>';
      html +='</tr>';

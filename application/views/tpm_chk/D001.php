...
<div class="col-md-3" style="text-align:left;">
  <p>เลขที่ใบเปิดงานสัญญาบริการ</p>
...
<div class="col-md-3" style="text-align:left;">
  <p>วันที่เปิดงานสัญญาบริการ</p><p class="required">*</p>
...
<div class="col-md-3" style="text-align:left;">
  <p>วันที่นัดหมาย</p>
  <div class="input-group" style="z-index:9  !important;">
  <input type="text" name="dateCpm" ID="dateCpm"  value="21/08/2558 09:00" readonly="readonly" class="form-control "> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
  </div>
</div> 
<div class="col-md-3" style="text-align:left;">
  <p>ผู้ขาย</p>  
  ...
  <div class="col-md-12">
    ...
    <div class="row form_input" style="text-align:left;margin-top:-10px;">
      <div class="col-md-8" style="text-align:left;">
        ...
        <input type="radio" name="chk_issue" value="1" checked="checked"> เครื่องทำงานปกติ
        <input type="radio" name="chk_issue" value="0">  พบปัญหาต้องดำเนินการแก้ไข       
      </div>
      <div class="col-md-3" style="text-align:left;">
        <p>แนบไฟล์สรุปผลการปฏิบัติงาน</p>
        <p><a href="<?php echo base_url(); ?>file_upload/tpm_overall/ผลการทดสอบ-PM001.pdf" target="_blank">ผลการทดสอบ-PM001.pdf</a></p>
      </div>
    </div>
    <div class="row form_input" style="text-align:left;">
      <div class="col-md-8" style="text-align:left;">
              ...
              <td>       
                  <select id="mf_owner_mtck" name="mf_owner_mtck" class="selectpicker show-tick form-control input-sm "  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก"  >
                   <option style="font-size:12px;" value="">----เลือก----</option>
                    ...
                    <option style="font-size:12px;" value="" selected>ช่างผู้ปฏิบัติงาน</option> 
                  </select>  
              </td>
              <td>
  ...
  <div class="col-md-12" style="text-align:left;">
    <fieldset>
      ...
      <div class="row form_input"> 
        <div class="col-md-3" style="text-align:left;">
          <p>แนบไฟล์ปิดงาน</p>
          <p><a href="<?php echo base_url(); ?>file_upload/tpm_overall/ปิดงาน-PM001.pdf" target="_blank">ปิดงาน-PM001.pdf</a></p>
        </div>
        <div class="col-md-3" style="padding-top:20px;">
          <input type="checkbox" id="chk_com_sit" checked="true" disabled="true"> ยืนยันการปิดงาน
        </div>
      </div>
    </fieldset>
  </div>
...
<div class="row form_input" style="margin-top:10px;">
  <div class="col-md-12" style="text-align:left;">
    <p>สถานะ</p>  
      <input type="radio"  name="status" value="1"  disabled > เปิดงาน
      <input type="radio"  name="status" value="2" disabled >  บันทึกผลการปฏิบัติงาน  
      <input type="radio"  name="status" value="3" disabled checked=checked>  ปิดงาน 
      <input type="radio"  name="status" value="0" disabled >  ยกเลิก 
  </div>
</div>
<div class="row form_input" style="margin-top:10px;">
  <div class="col-md-3" style="text-align:left;">

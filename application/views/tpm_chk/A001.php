...
<div class="col-md-3" style="text-align:left;">
  ...
  <div class="input-group" style="z-index:9  !important;">
  <input type="text" name="dateCpm" ID="dateCpm"  value="" readonly="readonly" class="form-control "> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
  </div>
</div> 
<div class="col-md-3" style="text-align:left;">
  <p>ผู้ขาย</p>  

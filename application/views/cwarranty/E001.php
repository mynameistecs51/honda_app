...
<div class="col-md-4" style="text-align:left;">
  ...
  <p class="required">*</p>
    <select id="id_minv" name="minv_name" class="selectpicker show-tick form-control input-sm "  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก"  >
      ...
      <option style="font-size:12px;" value="1" selected>PPPPP-UPS MODEL-001</option> 
...
<div class="col-md-4" style="text-align:left;">
  ...
  <div class="form-group">
    <input type="text" name="mbom_hdr_code" ID="mbom_hdr_code" value="BOM1500001-MODEL-001" readonly="true" class="form-control">
  </div> 
</div>
</div>
...
<input type="text" name="ref_invoice_no" id="ref_invoice_no" class="form-control" value="IN58080001" readonly="true">
</div>
  <div class="col-md-4" style="text-align:left;"> 
...
<div class="col-md-12" style="text-align:left;">
<p>สถานะ</p>  
  <input type="radio"  name="status" value="1" checked=checked> ในประกัน
  <input type="radio"  name="status" value="2" disabled >  นอกประกัน  
  <input type="radio"  name="status" value="0" >  ยกเลิกการรับประกัน 
</div>
</div>
<div class="row form_input" style="margin-top:10px;">

...
<div class="search form-inline">ค้นหา : 
    <input type="text" data-column="0"  class="search-input-text" placeholder="--เลขที่ผลิตภัณฑ์--"> 
    <input type="text" data-column="1"  class="search-input-text" placeholder="--ชื่อผลิตภัณฑ์--">  
    <input type="text" data-column="2"  class="search-input-text" placeholder="--ข้อมูลบริษัทหลัก--"> 
    <input type="text" data-column="2"  class="search-input-text" placeholder="--วันที่เริ่มรับประกัน--"> 
    <select data-column="4" class="search-input-select">
      <option style="font-size:12px;" value="0,1,2" selected>----สถานะ ทั้งหมด----</option>
      <option style="font-size:12px;" value="1">ในประกัน-หลังขาย</option>  
      <option style="font-size:12px;" value="1">นอกประกัน-หลังขาย</option>
      <option style="font-size:12px;" value="2">ในประกัน-หลังซ่อม</option> 
      <option style="font-size:12px;" value="2">นอกประกัน-หลังซ่อม</option> 
    </select>    
</div>
...
<thead>                       
  <tr>
    ...
    <th>ชื่อผลิตภัณฑ์</th>   
    <th>ข้อมูลบริษัทหลัก</th>
    <th>ข้อมูลสถานที่ไซต์งาน</th>
    <th>วันที่เริ่มรับประกัน</th> 
...
<tbody>
  <tr>
    <td>PPPPP-SSYYLXXX-VVVV</td>
    <td>MODEL-001</td> 
    <td>Thainology and Solutions CO.LTD.</td>
    <td>Thainology and Solutions CO.LTD.</td>
    <td>01/08/2558</td> 
    <td>01/08/2559</td>
    <td>ในประกัน-หลังขาย</td>
    <td>-</td>
    <td class="action"  ></td>
  </tr>
  <tr>

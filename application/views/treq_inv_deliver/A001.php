...
function add_row() 
{
  ...
  var html  ='<tr id="'+rows+'">';
      ...
      html +='<td><input type="text" class="form-control" name="issue[]" value="RW-20150001" readonly="true"></td>  ';

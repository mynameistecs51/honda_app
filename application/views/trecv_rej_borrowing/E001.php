...
function add_tr()
{
  var trhtml ='<tr>';
    ...
    trhtml +='<td><input type="text" name="" value=""  class="form-control" > </td>';
    trhtml +='<td><input type="text" name="" value=""  class="form-control" > </td>';
    trhtml +='<td><input type="text" name="" value=""  class="form-control" > </td>';
    trhtml +='<td><input type="text" name="" value=""  class="form-control" > </td>';
    trhtml +='<td>';
    ...
    trhtml +='<option style="font-size:12px;" value="3">อัน</option>';  
    trhtml +='</select>';
...
<div class="row form_input">
  ...
  <div class="col-md-3" style="text-align:left;">
      ...
      <div class="form-group">
        ...
        <input type="text" name="docdate" id="docdate_" value="<?=$dtnow?>" class="form-control "  readonly="true"> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
        </div>
      </div> 
  </div>
  <div class="col-md-3" style="text-align:left;">
...
<div class="row form_input">
  <div class="col-md-3" style="text-align:left;">
    ...
    <div class="form-group">
     <input type="text" name="" value="TRI00001"  class="form-control" readonly="true" >   
    </div> 
  </div>
  <div class="col-md-3" style="text-align:left;">
      ...
      <div class="form-group">
        <div class="input-group" style="z-index:8  !important;">
        <input type="text" name="docdate" id="docdate" value="<?=$dtnow?>" class="form-control " readonly="true" > <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
        </div>
      </div> 
  </div>
  <div class="col-md-3" style="text-align:left;">
...
<div class="col-md-12">
<fieldset>
<legend>รายการที่รับคืนยืมผลิตภัณฑ์</legend>
<div class="row form_input">
<div class="col-md-12">

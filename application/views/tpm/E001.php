...
<div class="col-md-2" style="text-align:left;">
  ...
  <div class="form-group">
  <p class="required">*</p> 
  <select name="tpm_dtl_sub_batch" ID="seltpmdtlsubbatch" class="selectpicker show-tick form-control input-sm tclaim_mcmp"  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก" >
    <option style="font-size:12px;" value="" >----เลือก----</option> 

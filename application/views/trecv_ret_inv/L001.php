...
<div class="search form-inline">ค้นหา : 
    <input type="text" data-column="0"  class="search-input-text" placeholder="--เลขที่ใบเปิดงานซ่อม--">
    <input type="text" data-column="1"  class="search-input-text" placeholder="--เลขที่ใบคืนของเสีย--"> 
    <input type="text" data-column="2"  class="search-input-text" placeholder="--เลขที่ใบรับคืนของเสีย--"> 
    <input type="text" data-column="3"  class="search-input-text" placeholder="--ผู้ทำรับ--">  
    ...
    <option style="font-size:12px;" value="0,1,2" selected>----ทั้งหมด----</option>
    <option style="font-size:12px;" value="1">รอรับคืน</option> 
    <option style="font-size:12px;" value="2">รับคืนแล้ว</option> 
...
<thead>                       
  <tr>
    <th>เลขที่ใบเปิดงานซ่อม</th>
    <th>ประเภทงาน</th>
    <th>เลขที่ใบคืนของเสีย</th>
    <th>วัน-เวลาที่คืนของเสีย</th> 
...
<tbody>
  ...
  <tr class="success">
    ...
    <td>เคลม</td>
    <td>T00003</td>
    <td>20/07/2558 09:05</td>
    <td>T00001</td>
    <td>20/07/2558 09:05</td> 
    <td>sirawitnee (เจ้าหน้าที่สโตส์)</td>
    <td>รับคืนแล้ว</td>
    <td>-</td>
    <td class="action2"></td>
  </tr>

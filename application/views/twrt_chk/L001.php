...
function view(num)
    { 
      var screenname="รายละเอียดข้อมูล :: การรับประกันผลิตภัณฑ์"; 
...
<div class="search form-inline">ค้นหา : 
    ...
    <input type="text" data-column="2"  class="search-input-text" placeholder="--Model--">
    <input type="text" data-column="2"  class="search-input-text" placeholder="--Brand--">
    <input type="text" data-column="2"  class="search-input-text" placeholder="--รุ่น--">
    <input type="text" data-column="2"  class="search-input-text" placeholder="--ชื่อบริษัทหลัก--">  
    <input type="text" data-column="2"  class="search-input-text" placeholder="--ชื่อไซต์งาน--"><br/>  
    ...
    <select data-column="4" class="search-input-select" style="width:182px; margin-right:0px;">
      <option style="font-size:12px;" value="0,1,2" selected>-- สถานะ ทั้งหมด --</option>
      <option style="font-size:12px;" value="1">ในประกัน</option> 
      <option style="font-size:12px;" value="2">นอกประกัน</option> 
      <option style="font-size:12px;" value="2">ยกเลิกการับประกัน</option> 
    </select>
</div>
...
<thead>                       
  <tr>
    ...
    <th width="170">Model</th>
    <th width="170">Brand</th> 
    <th width="170">รุ่น</th>
    <th width="230">ข้อมูลบริษัทหลัก</th> 
    <th width="230">ข้อมูลสถานที่ไซต์งาน</th> 
    <th width="170">รหัสอะไหล่</th>   
    <th width="120">วันที่เริ่มรับประกัน</th>
    <th width="140">วันที่สิ้นสุดรับประกัน</th>
    <th width="140">ประเภทการรับประกัน</th>
    <th width="150">สถานะการรับประกัน</th>
...
<tbody>
  <tr>
    ...
    <td>THAINOLOGY</td>
    <td>THAINOLOGY</td>
    <td>PPPPP-SSYYLXXX-VVV<BR>PPPPP-SSYYLXXX-VVV<BR>PPPPP-SSYYLXXX-VVV<BR>PPPPP-SSYYLXXX-VVV</td>  
    <td>10/07/2558<BR>10/07/2558<BR>10/07/2558<BR>10/07/2558</td> 
    <td>10/07/2560<BR>10/07/2560<BR>10/07/2560<BR>10/07/2560</td> 
    <td>หลังขาย<BR>หลังขาย<BR>หลังขาย<BR>หลังขาย</td>
    <td>ในประกัน<BR>ในประกัน<BR>ในประกัน<BR>ในประกัน</td>
    <td>-</td>
    <td class="action" ></td>
  </tr>
  <tr>

...
function add()
    {
    $(".add").click(function(){ 
      var screenname="เพิ่มข้อมูล :: <?=$pagename?>";
...
function edit(num,idx)
    {   
      var screenname="แก้ไขข้อมูล :: <?=$pagename?>"; 
...
function view(num)
    { 
      var screenname="รายละเอียดข้อมูล :: <?=$pagename?>"; 
...
<div class="search form-inline">ค้นหา : 
    ...
    <input type="text" data-column="0"  class="search-input-text" placeholder="--เลขที่ใบรับแจ้ง--"> 
    ...
    <input type="text" data-column="4"  class="search-input-text" placeholder="--Serial Number--"> <br>
...
<thead>                       
  <tr>
    <th>เลขที่<?=$pagename?></th> 
    <th>เลขที่ใบรับแจ้งเครื่องซ่อม</th> 

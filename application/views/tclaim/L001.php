...
$(function(){
  ...
  //$('#datefrom').datetimepicker({isBE: true,autoConversionField: true});
  var startDateTime = $('#datefrom');
  var endDateTime = $('#dateto');
  $.timepicker.datetimeRange(startDateTime,endDateTime,{ 
...
function add()
    {
    $(".add").click(function(){ 
      var screenname='เพิ่มข้อมูล  <img src="<?=$base_url?>/images/document.png" style="width:16px;height:16px;text-align:left;"> <?=$pagename?>';
...
function edit(num,idx)
    {   
      var screenname='แก้ไขข้อมูล <img src="<?=$base_url?>/images/document.png" style="width:16px;height:16px;text-align:left;"> <?=$pagename?>'; 
...
function view(num)
    { 
      var screenname='รายละเอียดข้อมูล <img src="<?=$base_url?>/images/document.png" style="width:16px;height:16px;text-align:left;"> <?=$pagename?>'; 
...
function modal_form(n,screenname)
   {
    ...
    div+='<!-- Modal -->';
  	div+='<div class="modal  fade modal-wide" id="myModal'+n+'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">';
...
<div class="search form-inline">ค้นหา : 
    <input type="text" data-column="0"  class="search-input-text" placeholder="--เลขที่<?php echo $pagename ?>--"> 
    <input type="text" data-column="1"  class="search-input-text" placeholder="--ผู้ขอ<?php echo $pagename ?>--"> 
    <input type="text" data-column="2"  class="search-input-text" placeholder="--บริษัทหลัก--"> 
    <input type="text" data-column="3"  class="search-input-text" placeholder="--ไซต์งาน--"> 
    <input type="text" data-column="4"  class="search-input-text" placeholder="--Serial Number--">
    <br>
    <input type="text" data-column="5"  class="search-input-text" placeholder="--อ้างอิงเลขที่ใบเคลม--"> 
    <input type="text" data-column="6"  class="search-input-text" placeholder="--อ้างอิงเลขที่ใบคืน--"> 
    <lable class="lable"> From :</lable><input type="text" data-column="3" ID="datefrom"  class="search-input-text" value="<?=$datefrom?>"> 
    <lable class="lable"> To :</lable><input type="text" data-column="4"  ID="dateto" class="search-input-text" value="<?=$dateto?>"> 
    <select data-column="4" class="search-input-select" style="width:180px; margin-right:5px;">
...
<thead>                       
  <tr>
    <th>เลขที่ใบเคลม</th> 
    <th>ผู้ขอเคลม</th>
    <th>ชื่อบริษัทหลัก</th>
    <th>ชื่อไซต์งาน</th>
    <th>อ้างอิงเลขที่<?=$pagename?></th>
    <th>อ้างอิงเลขที่ใบคืน</th> 
    <th>วันที่-เวลา<?=$pagename?></th>
    <th>สถานะ</th>
    <th>หมายเหตุ</th>
    <th>ดำเนินการ</th>
  </tr>

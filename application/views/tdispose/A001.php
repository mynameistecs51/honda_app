 ...
 <div class="row form_input">
  <div class="col-md-4" style="text-align:left;">
    <p>เลขที่ใบขอ Scrap</p>    
 	  <p class="required">*</p><input type="text" class="form-control" style=" background-color:#81BEF7;color:#FFFFFF;"value="--สร้างโดยระบบ--" readonly="true">
  </div>
  <div class="col-md-4" style="text-align:left;">
   ...
   <p class="required">*</p><div class="form-group">
         <select id="mf_owner_mtck" name="mf_owner_mtck" class="selectpicker show-tick form-control input-sm "  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก"  >
            ...
            <option style="font-size:12px;" value="">แบ็ตเตอรี่ - Battery</option> 
 ...
 <table class="table table-striped" id="tb_dispose">
    ...
    <td>
		<p class="required">*</p><div class="form-group">
 		...
 		<td>
    <p class="required">*</p><input type="text" class="form-control amount" id="amount1" name="amount[]"style="text-align:right;" required="true" >
    </td>

...
<div class="search form-inline">ค้นหา : 
    <input type="text" data-column="0"  class="search-input-text" placeholder="--เลขที่ใบขอ Scrap--"> 
    
    <select class="search-input-text">
      <option >--ประเภทสินค้าขอ Scrap--</option> 
      <option>แบ็ตเตอรี่ - Battery</option>
      <option>บอร์ดวงจร - Board</option>
    </select> 
...
<thead>                       
  <tr>
    <th>เลขที่ใบขอ Scrap</th>
    <th>ประเภทสินค้าขอ Scrap</th> 

...
<div class="col-md-3" style="text-align:left;">
  <p>แผนกที่เตรียมเครื่อง</p>
  <p class="required">*</p>
  <input type="text" name="name_req[]" id="name_req" value="Call Center" class="form-control " >
</div>   
<div class="col-md-3" style="text-align:left;">
  <p>ผู้จัดเตรียมเครื่อง</p> 
  <p class="required">*</p> 
  <input type="text" name="call_req[]" id="call_req" value="ดิษฐพงษ์ นิลนามะ" class="form-control " >  
</div>    
</div>

<div class="row form_input" style="margin-top:20px;">
<div class="col-md-3" style="text-align:left;">
  <p>เลขที่ใบแจ้งส่งเครื่องซ่อม</p>
  <input type="text" name="msn_hdr_code" value="RR58070001"  class="form-control"  readonly="true" >     
</div>
<div class="col-md-3" style="text-align:left;">
  <p>วันที่แจ้งส่งเครื่องซ่อม</p>
  <div class="input-group" style="z-index:9  !important;">
  <input type="text" name="treq_repair_date" ID="treq_repair_date"  value="<?=$dtnow?>" readonly="readonly" class="form-control "> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
  </div>
</div>  
<div class="col-md-3" style="text-align:left;">
  <p>แผนกที่แจ้งส่งเครื่องซ่อม</p>
  <p class="required">*</p>
  <input type="text" name="name_req[]" id="name_req" value="Admin Onsite" class="form-control " >
</div>   
<div class="col-md-3" style="text-align:left;">
  <p>ผู้แจ้งส่งเครื่องซ่อม</p> 
  <p class="required">*</p> 
  <input type="text" name="call_req[]" id="call_req" value="พุฒิพงศ์ ห้วงน้ำ" class="form-control " readonly="true" >  
</div>    
</div>
...
<div style="overflow-x:scroll;overflow-y: hidden;"> 
  <table class="table table-striped" id="tbdetail" style="table-layout: fixed;word-wrap: break-word;">
    ...
    <tbody>
      <tr id="1">
      <td><input type="text" class="form-control" name="issue[]" value="RW-20150001"></td>  
      <td><input type="text" class="form-control" name="dr[]" value="DR58090001"></td> 
      <td class="sn1"> 
      ...
      <td class="medel1"><input type="text" class="form-control" value="Pluto-YY"></td>
      <td>
      <div class="input-group" style="z-index:9  !important;">
      <input type="text" name="treq_repair_date" ID="treq_repair_date"  value="<?=$dtnow?>" readonly="readonly" class="form-control "> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
      </div></td>
      ...
      <td><input type="text" name="location" class="form-control _open" value="1.2"></td>
      <td><select name="pack_type" id="pack_type" class="form-control _open">
          <option>--เลือก--</option>
          <option selected="true">พร้อม</option>
          <option>ไม่พร้อม</option>
        </select></td>
        <td><textarea cols="1" style="height:35px;" class="form-control _open"></textarea></td>
      </tr>
    </tbody>
  </table>    
</div> 
...
$(function(){  
    ...
    /*$('input.text_open').attr('readonly',false);
    $('input._open').attr('readonly',false);
    $('select._open').attr('disabled',false);*/

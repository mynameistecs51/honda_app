  ...
  <div class="row form_input">
    ...
    <div class="col-md-3" style="text-align:left;">
        <p>วันที่<?php echo "$pagename"?></p> 
          <div class="input-group" style="z-index:8  !important;">
          <input type="text" name="docdate" id="docdate_" value="<?=$dateto?>" class="form-control " readonly="true"> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
          </div> 
    </div>  
    <div class="col-md-3" style="text-align:left;">
...
<div class="row form_input header_table" style="margin-top:20px;text-align:left;">
  <div class="col-md-12">
  <fieldset><legend>รายการที่ขอเบิกยืม</legend>
...
<div class="col-md-12">
<fieldset><legend>รายการที่จ่ายยืม</legend> 
<div class="row form_input header_table" style="text-align:left;">
  <div class="col-md-12">

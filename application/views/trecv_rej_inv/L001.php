...
<div class="search form-inline">ค้นหา : 
    ...
    <input type="text" data-column="1"  class="search-input-text" placeholder="--เลขที่ใบคืนสินค้า/อะไหล่--"> 
    <input type="text" data-column="2"  class="search-input-text" placeholder="--ผู้ทำรับ--">  
...
<thead>                       
  <tr>
    <th>ประเภทงาน</th>
    <th>เลขที่ใบงาน</th>
    <th>เลขที่ใบคืนสินค้า/อะไหล่</th>
    <th>วันที่คืน</th>

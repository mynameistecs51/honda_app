...
function rundatatable(){ 
    var dataTable = $('#employee-grid').DataTable( { 
        ...
        "serverSide": true,
        "ajax":{
            url :"<?php echo base_url(); ?>mcmp/getList", // json datasource
        ...
        "aoColumns": [{ 
                      ...
                      "mRender": function(data, type, full) { 
                       var html ='';
                        if($('#btn_view').val()==1){ 
                            html +='<img src="<?php echo base_url(); ?>images/list_view.png"   title="รายละเอียด" class="btnopt view" data-idview="' + full['id_mcmp'] + '"></img>';
                        }else{ 
                        ...
                        if($('#btn_edit').val()==1){ 
                            html +='<img src="<?php echo base_url(); ?>images/list_edit.png"   title="แก้ไข" class="btnopt edit" data-idedit="' + full['id_mcmp'] + '"></img>';
                        }else{ 
       ...
       // run_numrow();
        ...
        $('#employee-grid tbody').on( 'click', 'img.edit', function () {
         ...
         $('#employee-grid tbody').on( 'click', 'img.btnopt.view', function () { 
...
function modal_form(n,screenname)
   {
    ...
    div+='<!-- Modal -->';
  	div+='<div class="modal  fade" id="myModal'+n+'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">';
...
<?php if($btn['add']==1){ echo "<div class='add' ID='add'>+ เพิ่มรายการ</div>"; }else{ echo "<div class='noneadd'>+ เพิ่มรายการ</div>";} ?>
<div class="search">ค้นหา : 
    <input type="text" data-column="0"  class="search-input-text" placeholder="--รหัสบริษัท--"> 
    <input type="text" data-column="1"  class="search-input-text" placeholder="--ชื่อบริษัท(ENG)--">
    <input type="text" data-column="2"  class="search-input-text" placeholder="--ชื่อบริษัท(TH)--"> 
    <!--
    <lable class="lable"> DateFrom :</lable><input type="text" data-column="2" ID="dateform"  class="search-input-text" value="01-05-2015" style="width:160px;padding-left:80px;"> 
    <lable class="lable"> DateTo :</lable><input type="text" data-column="3"  ID="dateto" class="search-input-text" value="19-05-2015" style="width:160px;padding-left:60px;"> 
    -->
</div>
<table id="employee-grid"  cellpadding="0" cellspacing="0" class="table table-striped table-hover" >
<thead>                       
  <tr>
    <th>รหัสบริษัท</th>

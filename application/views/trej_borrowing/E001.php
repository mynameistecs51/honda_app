...
<div class="row form_input">
  ...
  <div class="col-md-4" style="text-align:left;">
	...
	<div class="col-md-4" style="text-align:left;">
		...
		<input type="text" name="treq_repair_date" id="treq_repair_date_" value="<?=$dateto?>" readonly="true" class="form-control "> <span class="input-group-addon"><i id="calIconTourDateDetails" class="glyphicon glyphicon-calendar"></i></span>
		</div>
	</div>
  <div class="col-md-4" style="text-align:left;">
    <p>วันที่กำหนดคืน</p>     
...
<div style="overflow-x:scroll;overflow-y: hidden; ">
 <table class="table table-striped" id="tb_claim"  style="table-layout: fixed;word-wrap: break-word;">  
  ...
  <tr>
    ...
    <td><input type="text" class="form-control" name="" value="M00254" readonly="true"></td>
    <td>
    ...
    <td><input type="text" name="" value="CHUPHOTIC" class="form-control" readonly="true"></td> 
    <td><input type="text" name="" value="BATTERY"   class="form-control" readonly="true"></td>
    <td><input type="text" name="" value="BAT-001"   class="form-control" readonly="true"></td>
    <td><input type="text" name="" value="5"   class="form-control" style="text-align:center;"></td>       
    <td>
    ...
    <td>
    <div class="status">
      <input type="radio"  name="status" value="1"  checked=checked;> ของดี
      <input type="radio"  name="status" value="2"   > ของเสีย  
    </div>
    </td>

...
<div class="search form-inline">ค้นหา : 
    ...
    <input type="text" data-column="1"  class="search-input-text" placeholder="--เลขที่ใบ<?php echo "$pagename";?>--"> 
...
<thead>                       
  <tr>
    ...
    <th>วันที่คืนอะไหล่</th>
    <th>ชื่อบริษัทหลัก</th> 
    <th>ชื่อสถานที่ไซต์งาน</th>
    <th>ผู้คืน</th> 
    <th>สถานะ</th>
    <th>หมายเหตุ</th>

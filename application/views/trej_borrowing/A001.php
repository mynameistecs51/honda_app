...
<input type="hidden"  name="base_url" ID="base_url" value="<?php echo $base_url; ?>">
    ...
    <div class="col-md-4" style="text-align:left;">
      ...
      <select id="" name="" class="selectpicker show-tick form-control input-sm "  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก"  >
      <option style="font-size:12px;" value="" selected>----เลือก----</option>
      <option style="font-size:12px;" value="">อะไหล่</option> 
...
<div style="overflow-x:scroll;overflow-y: hidden; ">
 <table class="table table-striped" id="tb_claim"  style="table-layout: fixed;word-wrap: break-word;"> 
  ...
  <tbody>
    ...
    <td><input type="text" name="" value=""   class="form-control" readonly="true"></td> 
    <td><input type="text" name="" value=""   class="form-control" readonly="true"></td>
    <td><input type="text" name="" value=""   class="form-control" readonly="true"></td>
    <td><input type="text" name="" value=""   class="form-control" readonly="true"></td>        
 		<td><input type="text" name="" value=""   class="form-control" style="text-align:center;"></td>   
    <td>
    <div class="form-group col-md-15">
       <select name="minv_dtl" class="selectpicker show-tick form-control input-sm tclaim_mcmp"  style="display: none;"  data-live-search="true" data-error="กรุณาเลือก" d>
          <option style="font-size:12px;" value="" selected>----เลือก----</option>

...
<div class="search form-inline">ค้นหา : 
    <input type="text" data-column="0"  class="search-input-text" placeholder="--เลขใบส่งซื้อ[PO]--"> 
    <input type="text" data-column="1"  class="search-input-text" placeholder="--เลขที่<?=$pagename?>--"> 
    <input type="text" data-column="2"  class="search-input-text" placeholder="--ผู้รับเข้า--"> 
    <input type="text" data-column="3"  class="search-input-text" placeholder="--รหัสวัตถุดิบ/อะไหล่--"> 
    <input type="text" data-column="4"  class="search-input-text" placeholder="--ชื่อวัตถุดิบ/อะไหล่--"> <br>
...
<div style="overflow-x:scroll;overflow-y: hidden;"> 
  <table id="employee-grid"  cellpadding="0" cellspacing="0" class="table table-striped table-hover" style="table-layout: fixed;word-wrap: break-word;"  >
    <thead>                       
      <tr>
        <th width="150">เลขใบสั่งซื้อ[PO]
        <th width="230">เลขที่<?=$pagename?></th>
        <th width="150">เลขที่ผลิตภัณฑ์</th>
        <th width="150">Part No.</th>
        <th width="150">Part Name</th>
        <th width="150">ผู้รับเข้า</th>
        <th width="150">วันที่-เวลารับเข้า</th>

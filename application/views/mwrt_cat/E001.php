...
function cancle() {
	if(confirm("ยกเลิกการดำเนินการ หรือไม่ ?"))
	{
		...
		location = base+"/mwrt_cat";
	}
}
function updateMwrt_cat()
  {
    $('#form').on('submit', function (e) {
        ...
        var comment= $('#comment').val(); 
            ...
            {
                type: 'POST',
                url: '<?php echo base_url(); ?>mwrt_cat/saveUpdate/',
...
<?php  foreach ($listMwrt_cat as $detail) { ?>
<input type="hidden"  name="base_url" ID="base_url" value="<?php echo $base_url; ?>">
<input type="hidden"  ID="idx" value="<?php echo $idx; ?>" >
<div class="form_input">
	<p>รหัสประเภทการรับประกัน</p>
	<input type="text" class="input" name="mwrt_cat_code" value="<?php echo $detail->mwrt_cat_code;   ?>" readonly>
	<input type="hidden" class="input" name="id_mwrt_cat" value="<?php echo $detail->id_mwrt_cat;   ?>" >
	<p>ชื่อประเภทการรับประกัน(ENG)</p>
	<input type="text" class="input" name="name_en" id="name_en" value="<?php echo $detail->name_en; ?>" >
	<p>ชื่อประเภทการรับประกัน(TH)</p> 

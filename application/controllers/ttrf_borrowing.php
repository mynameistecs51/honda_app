...
class ttrf_borrowing extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="ttrf_borrowing";
		$this->load->model('mdl_ttrf_borrowing');
...
public function getList()
{
    ...
    $sqlQuery= $this->mdl_ttrf_borrowing->getList($requestData);  

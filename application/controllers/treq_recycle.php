...
class treq_recycle extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="treq_recycle";
		$this->load->model('mdl_treq_recycle');
...
public function index()
{
	$SCREENID="L001";
	$this->mainpage();
	$this->load->view('treq_recycle/'.$SCREENID,$this->data);
	
}
public function getList()
{
    $requestData= $_REQUEST; 
    $sqlQuery= $this->mdl_treq_recycle->getList($requestData);  
...
{  
		...
		$this->data['listMempCat']= $this->mdl_treq_recycle->getMempCat();

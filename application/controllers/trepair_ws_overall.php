...
class trepair_ws_overall extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trepair_ws_overall";
		$this->load->model('mdl_trepair_ws_overall');
...
public function index()
{
	...
	$this->load->view('trepair_ws_overall/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_trepair_ws_overall->getMempCat();

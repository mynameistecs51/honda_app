...
class trecycle_overall extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trecycle_overall";
		$this->load->model('mdl_trecycle_overall');
...
public function index()
{
	$SCREENID="L001";
	$this->mainpage();
	$this->load->view('trecycle_overall/'.$SCREENID,$this->data);
	
}
public function getList()
{
    $requestData= $_REQUEST; 
    $sqlQuery= $this->mdl_trecycle->getList($requestData);  
...
{  
		...
		$this->data['listMempCat']= $this->mdl_trecycle_overall->getMempCat();

...
class tclaim extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="tclaim";
		$this->load->model('mdl_tclaim');
...
public function index()
{
	...
	$this->load->view('tclaim/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tclaim->getMempCat();
		...
		$this->load->library('HTMLtemplate');
...
public function ADD()
	{
			$SCREENID="A001";
			$this->mainpage($SCREENID);
		    $this->data['mcmp_info']=$this->htmltemplate->getHTML('mcmp_info'); 
			$this->load->view('tclaim/'.$SCREENID,$this->data); 
	}
public function DETAIL($id)
	{
			$SCREENID="D001";
			$this->mainpage($SCREENID); 
			//$this->data['listMemp']= $this->mdl_tclaim->getMemp($id);
			$this->load->view('tclaim/'.$SCREENID,$this->data);
	}

...
class tdeliver extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="tdeliver";
		$this->load->model('mdl_tdeliver');
...
public function index()
{
	...
	$this->load->view('tdeliver/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tdeliver->getMempCat();

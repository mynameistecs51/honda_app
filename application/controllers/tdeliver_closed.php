...
class tdeliver_closed extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="tdeliver_closed";
		$this->load->model('mdl_tdeliver_closed');
...
public function index()
{
	...
	$this->load->view('tdeliver_closed/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tdeliver_closed->getMempCat();

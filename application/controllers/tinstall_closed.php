...
class tinstall_closed extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="tinstall_closed";
		$this->load->model('mdl_tinstall_closed');
...
public function index()
{
	...
	$this->load->view('tinstall_closed/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tinstall_closed->getMempCat();

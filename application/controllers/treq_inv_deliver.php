...
class treq_inv_deliver extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="treq_inv_deliver";
		$this->load->model('mdl_treq_inv_deliver');
...
public function index()
{
	...
	$this->load->view('treq_inv_deliver/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_treq_inv_deliver->getMempCat();

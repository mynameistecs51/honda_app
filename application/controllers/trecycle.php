...
class trecycle extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trecycle";
		$this->load->model('mdl_trecycle');
...
public function index()
{
	$SCREENID="L001";
	$this->mainpage();
	$this->load->view('trecycle/'.$SCREENID,$this->data);
...
{  
		...
		$this->data['listMempCat']= $this->mdl_trecycle->getMempCat();

...
class trepair_os_closed extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trepair_os_closed";
		$this->load->model('mdl_trepair_os_closed');
...
public function index()
{
	...
	$this->load->view('trepair_os_closed/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_trepair_os_closed->getMempCat();

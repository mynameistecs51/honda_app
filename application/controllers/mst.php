...
class mst extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="mst";
		$this->load->model('mdl_mst');
...
public function index()
{
	...
	$this->load->view('mst/'.$SCREENID,$this->data);
...
public function getList()
{
    ...
    $sqlQuery= $this->mdl_mst->getList($requestData);  
...
{ 
		...
		$this->data['listMdept']= $this->mdl_mst->getMdept();
		$this->data['listMcmp']= $this->mdl_mst->getmcmp();
...
public function DETAIL($id)
	{
			$SCREENID="D001";
			$this->mainpage($SCREENID); 
			$this->data['listMst']= $this->mdl_mst->getMst($id);
			$this->load->view('mst/'.$SCREENID,$this->data);
	}

...
class trepair_os_overall extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trepair_os_overall";
		$this->load->model('mdl_trepair_os_overall');
...
public function index()
{
	...
	$this->load->view('trepair_os_overall/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_trepair_os_overall->getMempCat();

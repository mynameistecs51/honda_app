...
class trecv_ret_inv extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trecv_ret_inv";
		$this->load->model('mdl_trecv_ret_inv');
...
public function index()
{
	...
	$this->load->view('trecv_ret_inv/'.$SCREENID,$this->data);
	
}
public function getList()
{
    $requestData= $_REQUEST; 
    $sqlQuery= $this->mdl_trecv_ret_inv->getList($requestData);  

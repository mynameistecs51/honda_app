...
class trepair_quo_req extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trepair_quo_req";
		$this->load->model('mdl_trepair_quo_req');
...
public function index()
{
	...
	$this->load->view('trepair_quo_req/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_trepair_quo_req->getMempCat();

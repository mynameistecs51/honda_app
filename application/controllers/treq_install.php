...
class treq_install extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="treq_install";
		$this->load->model('mdl_treq_install');
		...
		$this->dtnow = $now->format('d/m/').$Y.$now->format(' H:i:s');
...
public function index()
{
	...
	$this->load->view('treq_install/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_treq_install->getMempCat();

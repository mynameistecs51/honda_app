...
class tsv_closed extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="tsv_closed";
		$this->load->model('mdl_tsv_closed');
...
public function index()
{
	...
	$this->load->view('tsv_closed/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tsv_closed->getMempCat();

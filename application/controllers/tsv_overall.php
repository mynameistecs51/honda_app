...
class tsv_overall extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="tsv_overall";
		$this->load->model('mdl_tsv_overall');
...
public function index()
{
	...
	$this->load->view('tsv_overall/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tsv_overall->getMempCat();

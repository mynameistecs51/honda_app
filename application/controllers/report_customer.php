...
{ 
	...
	{
		parent::__construct();
		$this->ctl="report_customer";
		$this->load->model('mdl_report_customer'); 
...
public function index()
{
	...
	$this->load->view('report_customer/'.$SCREENID,$this->data);
	
}
public function getList()
{
    $requestData= $_REQUEST; 
    $sqlQuery= $this->mdl_report_customer->getList($requestData);  
...
{ 
		$SCREENNAME="EMPLOYEE report_customer";
		...
		$this->data['mreport_customer_name'] = $this->session->userdata("mreport_customer_name");
		...
		$this->data["header"]=$this->template->getHeader(base_url(),$SCREENNAME,$this->data['mmember_name'],$this->data["lastLogin"],$this->data["id_mposition"],$this->data['mreport_customer_name']);
...
public function DETAIL($id)
	{
			...
			$this->data["datenow"] =$this->datenow;
			$this->mainpage($SCREENID); 
			$this->data['listreport_customer']= $this->mdl_report_customer->getreport_customer($id);
			$this->load->view('report_customer/'.$SCREENID,$this->data);
	}
...
public function saveadd()
{
	if($_POST):
     parse_str($_POST['form'], $post);
		//$code= $this->getCode();  
		$data = array(
			"mreport_customer_code"			=> $post['mreport_customer_code'],
		...
		//print_r($data);exit();
			$this->mdl_report_customer->addmreport_customer($data);
...
public function saveUpdate()
{
	...
	$id=$post['id_mreport_customer'];
			...
			$this->mdl_report_customer->updatemreport_customer($id,$data);

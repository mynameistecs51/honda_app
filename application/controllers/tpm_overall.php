...
class tpm_overall extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="tpm_overall";
...
public function DETAIL($id)
	{
			$SCREENID="D001";
			$this->mainpage(); 
		//	$this->data['listtpm_overall']= $this->mdl_tpm->gettpm_overallHdr($id);
			$this->load->view($this->ctl.'/'.$SCREENID,$this->data);
	}
public function EDIT($id,$idx,$is_phase)
	{
			$SCREENID="E00".$is_phase; 
			$this->mainpage(); 
			$this->data['idx']=$idx;
		//	$this->data['listtpm_overall']= $this->mdl_tpm->gettpm_overall($id);
			$this->load->view($this->ctl.'/'.$SCREENID,$this->data);
	}

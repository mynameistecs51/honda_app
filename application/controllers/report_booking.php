...
{ 
	...
	{
		parent::__construct();
		$this->ctl="report_booking";
		$this->load->model('mdl_report_booking'); 
...
public function index()
{
	...
	$this->load->view('report_booking/'.$SCREENID,$this->data);
	
}
public function getList()
{
    $requestData= $_REQUEST; 
    $sqlQuery= $this->mdl_report_booking->getList($requestData);  
...
{ 
		$SCREENNAME="EMPLOYEE report_booking";
		...
		$this->data['mreport_booking_name'] = $this->session->userdata("mreport_booking_name");
		...
		$this->data["header"]=$this->template->getHeader(base_url(),$SCREENNAME,$this->data['mmember_name'],$this->data["lastLogin"],$this->data["id_mposition"],$this->data['mreport_booking_name']);
...
public function DETAIL($id)
	{
			...
			$this->data["datenow"] =$this->datenow;
			$this->mainpage($SCREENID); 
			$this->data['listreport_booking']= $this->mdl_report_booking->getreport_booking($id);
			$this->load->view('report_booking/'.$SCREENID,$this->data);
	}
...
public function saveadd()
{
	if($_POST):
     parse_str($_POST['form'], $post);
		//$code= $this->getCode();  
		$data = array(
			"mreport_booking_code"			=> $post['mreport_booking_code'],
		...
		//print_r($data);exit();
			$this->mdl_report_booking->addmreport_booking($data);
...
public function saveUpdate()
{
	...
	$id=$post['id_mreport_booking'];
			...
			$this->mdl_report_booking->updatemreport_booking($id,$data);

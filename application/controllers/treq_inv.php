...
class treq_inv extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="treq_inv";
		$this->load->model('mdl_treq_inv');
...
public function index()
{
	...
	$this->load->view('treq_inv/'.$SCREENID,$this->data);
	
}
public function getList()
{
    $requestData= $_REQUEST; 
    $sqlQuery= $this->mdl_treq_inv->getList($requestData);  

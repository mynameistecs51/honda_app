...
class treq_egn extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="treq_egn";
		$this->load->model('mdl_tbkg_tnc');
...
public function index()
{
	...
	$this->load->view('treq_egn/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tbkg_tnc->getMempCat();

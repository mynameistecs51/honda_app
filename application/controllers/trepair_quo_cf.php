...
class trepair_quo_cf extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trepair_quo_cf";
		$this->load->model('mdl_trepair_quo_cf');
...
public function index()
{
	...
	$this->load->view('trepair_quo_cf/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_trepair_quo_cf->getMempCat();

...
class trepair_ws_closed extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trepair_ws_closed";
		$this->load->model('mdl_trepair_ws_closed');
...
public function index()
{
	...
	$this->load->view('trepair_ws_closed/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_trepair_ws_closed->getMempCat();

...
class trej_borrowing extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trej_borrowing";
		$this->load->model('mdl_trej_borrowing');
...
public function index()
{
	...
	$this->load->view('trej_borrowing/'.$SCREENID,$this->data);
	
}
public function getList()
{
    $requestData= $_REQUEST; 
    $sqlQuery= $this->mdl_trej_inv->getList($requestData);  

...
class trecycle_closed extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trecycle_closed";
		$this->load->model('mdl_trecycle_closed');
...
public function index()
{
	$SCREENID="L001";
	$this->mainpage();
	$this->load->view('trecycle_closed/'.$SCREENID,$this->data);
	
}
public function getList()
{
    $requestData= $_REQUEST; 
    $sqlQuery= $this->mdl_trecycle_closed->getList($requestData);  
...
{  
		...
		$this->data['listMempCat']= $this->mdl_trecycle_closed->getMempCat();

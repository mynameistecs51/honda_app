...
class tinstall_overall extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="tinstall_overall";
		$this->load->model('mdl_tinstall_overall');
...
public function index()
{
	...
	$this->load->view('tinstall_overall/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tinstall_overall->getMempCat();

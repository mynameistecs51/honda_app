...
class trepair extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trepair";
		$this->load->model('mdl_tinf_ins');
...
public function index()
{
	...
	$this->load->view('trepair/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tinf_ins->getMempCat();

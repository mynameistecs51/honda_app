...
class tinstall extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="tinstall";
		$this->load->model('mdl_tinstall');
...
public function index()
{
	...
	$this->load->view('tinstall/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tinstall->getMempCat();

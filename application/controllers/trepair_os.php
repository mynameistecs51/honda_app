...
class trepair_os extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trepair_os";
		$this->load->model('mdl_trepair_os');
...
public function index()
{
	...
	$this->load->view('trepair_os/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_trepair_os->getMempCat();

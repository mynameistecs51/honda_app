...
class trepair_ws extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trepair_ws";
		$this->load->model('mdl_trepair_ws');
...
public function index()
{
	...
	$this->load->view('trepair_ws/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_trepair_ws->getMempCat();

...
class tdeliver_cf extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="tdeliver_cf";
		$this->load->model('mdl_tdeliver_cf');
...
public function index()
{
	...
	$this->load->view('tdeliver_cf/'.$SCREENID,$this->data);
...
{ 
		...
		$this->data['listMempCat']= $this->mdl_tdeliver_cf->getMempCat();

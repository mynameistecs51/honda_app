...
class trecv_borrowing extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trecv_borrowing";
		$this->load->model('mdl_trecv_borrowing');
...
public function index()
{
	...
	$this->load->view('trecv_borrowing/'.$SCREENID,$this->data);

...
class trecv_rej_borrowing extends CI_Controller 
{ 
	public function __construct()
	{
		parent::__construct();
		$this->ctl="trecv_rej_borrowing";
		$this->load->model('mdl_trecv_rej_borrowing');
...
public function index()
{
	...
	$this->load->view('trecv_rej_borrowing/'.$SCREENID,$this->data);
	
}
public function getList()
{
    $requestData= $_REQUEST; 
    $sqlQuery= $this->mdl_trecv_inv->getList($requestData);  

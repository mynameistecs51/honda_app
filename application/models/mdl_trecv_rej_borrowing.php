<?php
   class mdl_trecv_rej_borrowing extends CI_Model
   {
	  ...
	  public function addMbomHdr($data){
		$this->db->insert('mbom_hdr', $data);
	  }

	  public function addMbomDtl($data){
		$this->db->insert('mbom_dtl', $data);
	  }

	  public function updateMbom_hdr($id,$data){
		$this->db->where('id_mbom_hdr', $id);
		$this->db->update('mbom_hdr', $data);
	  }

	  public function updateMbom_dtl($id,$data){

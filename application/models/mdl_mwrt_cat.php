<?php
   class mdl_mwrt_cat extends CI_Model
   {
	  ...
	  public function addMwrt_cat($data){
		$this->db->insert('mwrt_cat', $data);
	  }

	  public function updateMwrt_cat($id,$data){
		$this->db->where('id_mwrt_cat', $id);
		$this->db->update('mwrt_cat', $data);
	  }
 ...
 public function getList($requestData){
        ...
        $sql_search.=" AND mwrt_cat_code LIKE '%".$requestData['columns'][0]['search']['value']."%' ";
        } 

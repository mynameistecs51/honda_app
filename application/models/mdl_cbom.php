<?php
   class mdl_cbom extends CI_Model
   {
	  ...
	  public function addcbomHdr($data){
		$this->db->insert('cbom_hdr', $data);
	  }

	  public function addcbomDtl($data){
		$this->db->insert('cbom_dtl', $data);
	  }

	  public function updatecbom_hdr($id,$data){
		$this->db->where('id_cbom_hdr', $id);
		$this->db->update('cbom_hdr', $data);
	  }

	  public function updatecbom_dtl($id,$data){
		$this->db->where('id_cbom_dtl', $id);
		$this->db->update('cbom_dtl', $data);
	  }

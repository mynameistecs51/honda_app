<?php
   class Mdl_ccontract_warranty extends CI_Model
   {
	  ...
	  public function addMsnHdr($data){
		$this->db->insert('msn_hdr', $data);
	  }

	  public function addMsnDtl($data){
		$this->db->insert('msn_dtl', $data);
	  }

	  public function updateMsn_hdr($id,$data){
		$this->db->where('id_msn_hdr', $id);
		$this->db->update('msn_hdr', $data);
	  }

	  public function updateMsn_dtl($id,$data){
		$this->db->where('id_msn_dtl', $id);
		$this->db->update('msn_dtl', $data);
	  }
